...
export default class MakeQuiz extends React.Component {

   constructor(props) {
       super(props);
       this.state = {
           categories: ['SDLC', 'JavaScript'],
           categoryVal: 'SDLC',
...
//changing answers
   ...
   //saving the quiz to the database using axios 
   saveQuiz = () => {
       let quiz = {
   ...
   render() {
       return (
           <div className="make-quiz-wrapper">
               <Message model={this.state.showToast} message="quiz made" />
               <div>
                   <Nav />
               </div>
               ...
               <div className="main">
                   ...
                   <div className="card">
                       ...
                       <div className="box">
                           <span id="span">Must be logged in to take</span>
                       ...
                       <Modal model={this.state.addQuestion}>
